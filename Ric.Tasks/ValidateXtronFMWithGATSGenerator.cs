...
using Ric.Util;
using ProcessContext = Ric.Core.ProcessContext;
...
namespace Ric.Tasks
{
    ...
    public class ValidateXtronFMWithGATSGenerator : GeneratorBase
    {
        ...
        private void GetRics(string chainRic, out string outRicsFilePath)
        {
            ...
            try
            {
                using (Ric.Core.ProcessContext processContext = new Ric.Core.ProcessContext(@"D:\\Data2XML\\Data2XML.exe", argument, "D:\\Data2XML"))
                {
