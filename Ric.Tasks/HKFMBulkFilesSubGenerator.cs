...
namespace Ric.Tasks
{
    public class HKFMBulkFilesSubGenerator
    {
        ...
        public void StartHKBulkFileGeneratorJob()
        {
            ...
            GenerateHKGEQLB(outputPath + "\\" + parent.RicTemplatePath, RicListWarrant, ChineseListWarrant);
            //Generate HKG_EQLBMI.txt
            GenerateHKGEQLBMI(outputPath + "\\" + parent.RicTemplatePath, RicListCbbc, RicListWarrant);
            //Generate BK.txt
            GenerateBK(outputPath + "\\" + parent.RicTemplatePath, RicListCbbc, RicListWarrant);
            //Generate MI.txt
            GenerateMI(outputPath + "\\" + parent.RicTemplatePath, RicListCbbc, RicListWarrant);
            //Generate MI_FMSddMMMyyyy.csv 
            GenerateMIFMS(outputPath + "\\" + parent.RicTemplatePath, RicListCbbc, RicListWarrant);
