...
{
    public class KoreaOptionMapNewManager : ManagerBase
    {
        const string ETI_KOREA_CODEMAP_TABLE_NAME = "ETI_Korea_CodeMapNew";
        const string ETI_KOREA_OPTION_LTD_TABLE_NAME = "ETI_Korea_OptionLTDNew";
