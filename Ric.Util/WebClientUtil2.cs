...
namespace Ric.Util
{
    ...
    public class WebClientUtil
    {
        ...
        public static void DownloadFile(AdvancedWebClient wc, string uri, int timeout, string targetFilePath, string postData)
        {
            ...
            using (FileStream fs = new FileStream(targetFilePath, FileMode.OpenOrCreate, FileAccess.ReadWrite))
            {
        ...
        public static string GetPageSource(AdvancedWebClient wc, string uri, int timeout, string postData, Encoding encoding)
        {
            ...
            string content_Encoding = wc.ResponseHeaders["Content-Encoding"];
            ...
            if (encoding == null)
            {
                ...
                if (encoding2 != null && !Equals(encoding2, encoding))
                {
