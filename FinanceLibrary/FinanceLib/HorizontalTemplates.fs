...
module NdaTemplate =
    ...
    let TwIdnCb = [
        ...
        HLine(["{ric}.TWO"; "{displayname} CB{ric}%5,5"; "{ric}.TWO"; "{ric}"; "O{ric}"; "****"; "{chinesename}"; "{ric}%4.TWO"; "{effectivedateidn}"; "0#{ric}%4rel{type}"; "t{ric}.TWO"; "{ric}"; "{isin}"; "{strike}"; "{ric}"; "OTCTWS_EQLB"])
    ]

    let TwCbBulk = [
        Titles(["Date"; "Display Name"; "RIC"; "ISIN"; "Official Code"])
        HLine(["{effectivedate}"; "{displayname} CB{ric}%5,5"; "{ric}.TWO"; "{isin}"; "{ric}"])
    ]
