...
namespace Ric.Tasks.Korea
{
    ...
    {       
        ...
        private void GrabDataFromKindWebpage()
        {
            ...
            try
            {
                string uri = string.Format("http://kind.krx.co.kr/disclosure/searchtotalinfo.do?method=searchTotalInfoMain");
                ...
                //////////////////////////////
                uri = @"http://kind.krx.co.kr/common/searchcorpname.do";
                ...
                request.KeepAlive = true;
                request.UserAgent = @"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.57 Safari/537.36";
                string postData = string.Format("method=searchCorpNameJson&forward=&searchCodeType=&searchCorpName=%EC%8B%A0%EC%A3%BC%EC%9D%B8%EC%88%98%EA%B6%8C%EC%A6%9D%EA%B6%8C+%EC%8B%A0%EA%B7%9C%EC%83%81%EC%9E%A5&repIsuSrtCd=&isurCd=&fdName=&pageIndex=1&currentPageSize=15&scn=&srchFd=2&kwd=%EC%8B%A0%EC%A3%BC%EC%9D%B8%EC%88%98%EA%B6%8C%EC%A6%9D%EA%B6%8C+%EC%8B%A0%EA%B7%9C%EC%83%81%EC%9E%A5&fromData={0}&toData={1}", startDate, endDate);
                ...
                uri = @"http://kind.krx.co.kr/disclosure/searchtotalinfo.do";
                postData = string.Format("method=searchTotalInfoSub&forward=searchtotalinfo_detail&searchCodeType=&searchCorpName=%EC%8B%A0%EC%A3%BC%EC%9D%B8%EC%88%98%EA%B6%8C%EC%A6%9D%EA%B6%8C+%EC%8B%A0%EA%B7%9C%EC%83%81%EC%9E%A5&repIsuSrtCd=&isurCd=&fdName=all_mktact_idx&pageIndex=1&currentPageSize=15&scn=mktact&srchFd=2&kwd=%EC%8B%A0%EC%A3%BC%EC%9D%B8%EC%88%98%EA%B6%8C%EC%A6%9D%EA%B6%8C+%EC%8B%A0%EA%B7%9C%EC%83%81%EC%9E%A5&fromData={0}&toData={1}", startDate, endDate);
                request = WebRequest.Create(uri) as HttpWebRequest;
                request.Timeout = 300000;
                request.Method = "POST";
                request.CookieContainer = cookies;
                ...
                request.Headers["Accept-Encoding"] = @"gzip,deflate,sdch";
                request.Headers["Accept-Language"] = @"en-US,en;q=0.8,zh-CN;q=0.6,zh;q=0.4";
                request.Headers["Origin"] = @"http://kind.krx.co.kr";
                request.Headers["X-Requested-With"] = @"XMLHttpRequest";
                request.ContentType = @"application/x-www-form-urlencoded; charset=UTF-8";
                request.Referer = @"http://kind.krx.co.kr/disclosure/searchtotalinfo.do?method=searchTotalInfoMain";
                //request.Headers["Cache-Control"] = @"max-age=0";
                request.KeepAlive = true;
                request.UserAgent = @"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.57 Safari/537.36"; 
       ...
       /// <param name="dt">warrants table</param>
        ...
        private void GenerateEMAFile()
        {
            ...
            try
            {
               ...
               // content.Add(emaTitle);
                ...
                AddResult(fileName,filePath,"EMA File");
                AddResult("FM Files Copies",folderEMA,"FM Files Copies Folder");
        ...
        private void WriteAddGEDAFile(System.Data.DataTable dt)
        {
            try
            {
                ...
                AddResult(fileName,filePath,"GEDA FILE");
            }
            catch(Exception ex)
            {
