...
namespace Ric.Tasks.Korea
{
    ...
    {
        private static readonly string CONFIGFILE_NAME = ".\\Config\\Korea\\KOREA_AutoSendFMEmail.config";
        private KOREA_AutoSendFMEmailConfig configObj = null;
        ...
        {
            base.Initialize();
            configObj = ConfigUtil.ReadConfig(CONFIGFILE_NAME, typeof(KOREA_AutoSendFMEmailConfig)) as KOREA_AutoSendFMEmailConfig;
        ...
        public void StartSendMail()
        {
            ...
            AddResult("EMAFile",emaFileDir,"EMA File Today");
        }
