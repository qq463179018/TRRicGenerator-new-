...
namespace Ric.Tasks.Korea
{
    ...
    public class StockOptionDailyAndMonthlyMaintain : GeneratorBase
    {
        ...
        private void GetLastPriceFromGats(Process gatsProcess, string rics)
        {
            ...
            string result = gats.GetGatsResponse(rics, fids);
        ...
        private void GenerateFiles()
        {
            ...
            if (newGEDA)
            {
                AddResult(fileNameNew, filePathNew, "New Added");
            }
            if (normalGEDA)
            {
                AddResult(fileNameGEDA, filePathGEDA, "GEDA File");
                AddResult(fileNameNDA, filePathNDA, "NDA File");
            }
        ...
        private void GenerateUSDFiles()
        {
            ...
            if (newGEDA)
            {
                AddResult(fileNameNew, filePathNew, "KRW New Added");
            }
            if (normalGEDA)
            {
                AddResult(fileNameGEDA, filePathGEDA, "KRW GEDA File");
                AddResult(fileNameNDA, filePathNDA, "KRW NDA File");
            }
        }
